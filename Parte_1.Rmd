...
Se procede a realizar la optimización en dos dimensiones de la función Rosenbrock.

```{r opt_GA_rosenbrock}
postfit_rosenbrock <- make_postfit("pop_rosenbrock", "best_rosenbrock")
...
```{r create_rosenbrock_ga_gif, eval = TRUE, echo=FALSE, include=FALSE}
